...
1. Visit https://webnnreport.org/ or run the WebNN demos in [WebNN Developer Preview](https://microsoft.github.io/webnn-developer-preview/demos/image-classification/?provider=webnn&devicetype=gpu&model=mobilenet-v2&run=5)
2. Navigate to `chrome://webnn-internals/`

The `Runtime Backend` and `Execution Providers` in use will be displayed here.
