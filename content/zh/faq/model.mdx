...
Find operations and hardware support details of [LiteRT](../api-reference/browser-compatibility/litert), [Windows ML](../api-reference/browser-compatibility/windowsml) and [Core ML](../api-reference/browser-compatibility/coreml) backends.
