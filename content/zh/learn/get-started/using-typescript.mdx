...
如果没有类型定义，TypeScript 粘贴 WebNN API 对象和方法则视为具有 `unknown` 类型：
...
有关完整的工作示例，请参阅 [WebNN TypeScript Vanilla Example](https://github.com/ibelem/webnn-typescript-vanilla-example/) 存储库，其中演示了：
